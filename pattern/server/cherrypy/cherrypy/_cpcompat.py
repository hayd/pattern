...
try:
    ...
    # Python 2
    from future.standard_library.urllib.parse as urllib_parse import urljoin
...
try:
    ...
    from future.standard_library.http.cookies as http_cookies import SimpleCookie, CookieError
    from future.standard_library.http.client as http_client import BadStatusLine, HTTPConnection, IncompleteRead, NotConnected
    from future.standard_library.http.server as http_server import BaseHTTPRequestHandler
except ImportError:
    # Python 3
...
if py3k:
    ...
    try:
        from future.standard_library.http.client as http_client import HTTPSConnection
    except ImportError:
        HTTPSConnection = None
...
class SetDaemonProperty(object):
